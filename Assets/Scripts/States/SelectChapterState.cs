...
/// <summary>
/// This class represents the select chapter state.
/// </summary>
public class SelectChapterState : GameState {
    //--------------------------------------------------------------------------------------
    // Properties:
    //--------------------------------------------------------------------------------------
    ...
    public override void OnGUI() {
        ...
        GUI.Label(titleLblPos, Strings.SELECT_CHAPTER_TITLE, titleStyle);
